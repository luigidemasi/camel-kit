...
class GraphParameterizedCommandsTest {
    ...
    @Test void findByType() throws Exception {
    ...
    @Test void pathBetweenNodes() throws Exception {
    ...
    @Test void subgraphReturnsNodesAndEdges() throws Exception {
    ...
    private String run(GraphQueryCommand cmd, String... args) {
        ...
        full[0] = "--graph-file"; full[1] = graphFile.toString();

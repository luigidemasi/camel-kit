...
7. 5. Deploying Quarkus applications
8. 6. Testing
9. 7. Setting up Maven locally
10. 8. Sample applications
11. [Legal Notice](#idm140139105254896)
...
## Introduction to Red Hat build of Apache Camel for Quarkus.

[Legal Notice](#idm140139105254896)
...
## [Preface Copy link](#idm140139111005344)
...
For more information, see the [Setting up Quarkus applications for HawtIO Online with Jolokia](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.14/html/hawtio_diagnostic_console_guide/setting-applications-for-hawtio-online) section in the [HawtIO Diagnostic Console](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.14/html/hawtio_diagnostic_console_guide/index) documentation
...
For more information about Tooling in Red Hat build of Apache Camel, see [Tooling Guide](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.14/html-single/tooling_guide_for_red_hat_build_of_apache_camel/index) .
...
You can use [code.camel.redhat.com](https://code.camel.redhat.com/) to generate a Quarkus Maven project which automatically adds and configures the extensions that you want to use in your application.
...
- Creating the skeleton application using [code.camel.redhat.com](https://code.camel.redhat.com/)
- Adding a simple Camel route
- Exploring the application code
- Compiling the application in development mode
- Testing the application

#### [4.2.2. Generating the skeleton application with a code generator Copy link](#generating_the_skeleton_application_with_a_code_generator)

You can bootstrap and generate projects on [code.camel.redhat.com](https://code.camel.redhat.com/) .
...
For more information about using code.camel.redhat.com to generate Quarkus Maven projects, see [Creating a Quarkus Maven project](https://docs.redhat.com/en/documentation/red_hat_build_of_quarkus/3.27/html-single/getting_started_with_red_hat_build_of_quarkus/index#proc-creating-quarkus-project-using-code-quarkus-redhat-com_quarkus-getting-started) in the *Getting started with Red Hat build of Quarkus* guide.

**Procedure**

1. In the [code.camel.redhat.com](https://code.camel.redhat.com/) website, select the following extensions:
...
#### [4.2.5. Development mode Copy link](#getting-started-development-mode)
...
Refer to Quarkus documentation [Development mode](https://quarkus.io/version/3.27/guides/maven-tooling#dev-mode) section for more details about the development mode.
...
[Quarkus Native executable guide](https://quarkus.io/version/3.27/guides/building-native-image) contains more details, including [steps for creating a container image](https://quarkus.io/version/3.27/guides/building-native-image#creating-a-container) .

### [4.3. Building your first project with Kaoto Copy link](#getting-started-with-kaoto_camel-quarkus-extensions-getting-started)
...
#### [4.3.1. Getting started with Kaoto Copy link](#building-your-first-project-with-kaoto)

Note

This section assumes you have already installed VS Code with the Kaoto extension. For details, see the [Kaoto documentation](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.14/html/kaoto_camel_designer/index) .

You also need to have Camel CLI installed. For details, see the [Using Camel CLI with Red Hat build of Apache Camel for Quarkus](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.14/html-single/tooling_guide_for_red_hat_build_of_apache_camel/) .
...
##### [4.3.1.1. Preparing the Workspace Copy link](#preparing_the_workspace)

To create a Visual Studio Code workspace for your project:

1. Open your Visual Studio Code instance.
2. Select the Kaoto view by clicking the Kaoto Camel button on the left hand side.
Kaoto VS Code
...
<!-- 🖼️❌ Image not available. Please use `PdfPipelineOptions(generate_picture_images=True)` -->
6. Select a workspace folder to store our project files:
open folder
...
<!-- 🖼️❌ Image not available. Please use `PdfPipelineOptions(generate_picture_images=True)` -->
9. Browse to a suitable folder and click `Open` .

The folder is added to the File Explorer window on the left hand side.

##### [4.3.1.2. Creating your first Camel Route Copy link](#creating_your_first_camel_route)
...
6. Enter a name for the file (without file extension). A basic route is created and displayed in the editor window:
new route
...
##### [4.3.1.2.1. Launching the Camel Route Copy link](#launching_the_camel_route)

You can test the integration locally from the `Integration` tab.

1. Click the `run` button next to the Camel Route file name. The running route is displayed in the `Deployments` section. The Route is launched locally through [Camel CLI](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.14/html-single/tooling_guide_for_red_hat_build_of_apache_camel/) . You can view the output in the *Terminal* window at the bottom of the window. The integration is launched in *Dev Mode* . Changes done in the editor or to the source code are reloaded when save the integration.
Kaoto VS Code run

<!-- 🖼️❌ Image not available. Please use `PdfPipelineOptions(generate_picture_images=True)` -->
3. To control the run, hover over the route in the Deployments section to show the `stop` and `pause` buttons.

##### [4.3.1.2.2. Accessing the Source Code Copy link](#accessing_the_source_code)
...
#### [4.3.2. Additional resources Copy link](#getting-started-with-kaoto_camel-quarkus-extensions-getting-started)

- [Kaoto documentation](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.14/html/kaoto_camel_designer/index)
- [Using Camel CLI with Red Hat build of Apache Camel for Quarkus](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.14/html-single/tooling_guide_for_red_hat_build_of_apache_camel/)
...
For compatibility with earlier Quarkus versions, the default build strategy is **S2I** .

### [5.1. Docker build Copy link](#docker_build)
...
To select the build strategy, use the `quarkus.openshift.build-strategy` property:
...
For more details, see the section [Deploying Red Hat build of Quarkus Java applications to OpenShift Container Platform by using a Docker build strategy](https://docs.redhat.com/en/documentation/red_hat_build_of_quarkus/3.27/html/deploying_your_red_hat_build_of_quarkus_applications_to_openshift_container_platform/deploying-to-openshift-docker-howto) in the [Deploying Red Hat build of Quarkus applications to OpenShift Container Platform](https://docs.redhat.com/en/documentation/red_hat_build_of_quarkus/3.27/html/deploying_your_red_hat_build_of_quarkus_applications_to_openshift_container_platform) documentation.

### [5.2. Source to Image (S2I) Copy link](#source_to_image_s2i)
...
For more details, see the section [Using S2I to deploy Red Hat build of Quarkus applications to OpenShift Container Platform](https://docs.redhat.com/en/documentation/red_hat_build_of_quarkus/3.27/html/deploying_your_red_hat_build_of_quarkus_applications_to_openshift_container_platform/deploying-to-openshift-s2i-howto) in the [Deploying Red Hat build of Quarkus applications to OpenShift Container Platform](https://docs.redhat.com/en/documentation/red_hat_build_of_quarkus/3.27/html/deploying_your_red_hat_build_of_quarkus_applications_to_openshift_container_platform) documentation.

### [5.3. Binary S2I Copy link](#binary_s2i)
...
1. In the project directory that contains the `pom.xml` file, download a repository for a Maven project by running a command such as the following: `mvn org.apache.maven.plugins:maven-dependency-plugin:4.10.6:go-offline -Dmaven.repo.local=/tmp/my-project` Copy to Clipboard Toggle word wrap In this example, Maven dependencies and plug-ins that are required to build the project are downloaded to the `/tmp/my-project` directory.
...
The [Red Hat build of Quarkus examples](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/) repository contains a number of examples on how to integrate with Camel for a variety of use cases. They provide best practice advice and describe common patterns that we see in integration and messaging problems.
...
| Example                                                                                                                                                                                                                                                                                                                           | Description                                                                                                                                                                                                                                                       |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [AMQP](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/amqp)                                                                                                                                                                                                                                             | Shows how to produce and consume messages to an ActiveMQ Artemis broker using AMQP.                                                                                                                                                                               |
| [Artemis to ElasticSearch](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/artemis-elasticsearch)                                                                                                                                                                                                        | Shows how the message is consumed from the Apache Artemis broker using MQTT protocol, transformed and loaded into ElasticSearch                                                                                                                                   |
| [Camel Quarkus CXF SOAP example](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/cxf-soap)                                                                                                                                                                                                               | Shows how to use Camel CXF SOAP component.                                                                                                                                                                                                                        |
| [Communication with Netty over TCP](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/netty-custom-correlation)                                                                                                                                                                                            | Shows how to use TCP communication with Netty using a custom codec to encode and decode the data over the wire.                                                                                                                                                   |
| [Custom](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/timer-log-main)  [`main()`](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/timer-log-main)                                                                                                                            | Shows how to start Camel from a custom  ``` main() ```  method                                                                                                                                                                                                    |
| [Deploying a Camel Route in AWS Lambda](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/aws-lambda)                                                                                                                                                                                                      | Shows how to deploy a Camel Quarkus route as an AWS Lambda function                                                                                                                                                                                               |
| [Extract, Transform and Load between two databases](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/jdbc-datasource)                                                                                                                                                                                     | Shows how to extract, transform and load between two databases                                                                                                                                                                                                    |
| [FHIR](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/fhir)                                                                                                                                                                                                                                             | Shows how to use Camel FHIR with Quarkus.                                                                                                                                                                                                                         |
| [File consumer with Bindy &amp; FTP](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/file-bindy-ftp)                                                                                                                                                                                                     | Shows how to consume CSV files, marshal & unmarshal the data and send it onwards via FTP                                                                                                                                                                          |
| [HTTP with vanilla JAX-RS or with Camel](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/http-log)  [`platform-http`](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/http-log)  [component](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/http-log) | Shows how to create HTTP endpoints using either the RESTEasy                                                                                                                                                                                                      |
| [Health](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/health)                                                                                                                                                                                                                                         | Shows how to use Camel health-checks with Quarkus.                                                                                                                                                                                                                |
| [JMS and JPA](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/jms-jpa)                                                                                                                                                                                                                                   | Shows how to run a Camel Quarkus application that supports JTA transactions on three external transactional resources: a database (MySQL), a messaging broker (Artemis) and a simulated XAResource which can demonstrate the commit, rollback and crash recovery. |
| [JPA idempotent repository](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/jpa-idempotent-repository)                                                                                                                                                                                                   | Shows how to consume a message only once, even when the message is delivered multiple times                                                                                                                                                                       |
| [JTA and JPA](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/jta-jpa)                                                                                                                                                                                                                                   | Shows how to run a Camel Quarkus application that supports JTA transactions on two external transactional resources: a database (MySQL) and a simulate XAResource which can demonstrate the commit, rollback and crash recovery.                                  |
| [Kafka example](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/kafka)                                                                                                                                                                                                                                   | Shows how to produce and consume messages in a Kafka topic, using Strimzi Operator                                                                                                                                                                                |
| [Kamelet Chuck Norris](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/kamelet-chucknorris)                                                                                                                                                                                                              | Shows how you can build a simple Kamelet and use with your Camel applications.                                                                                                                                                                                    |
| [Leader election in Kubernetes: A Camel Quarkus Master example](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/cluster-leader-election)                                                                                                                                                                 | Shows how to use Camel Master component.                                                                                                                                                                                                                          |
| [Message Bridge](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/message-bridge)                                                                                                                                                                                                                         | Shows how to configure AMQ and IBM MQ clients to use the connection pooling and XA transactions.                                                                                                                                                                  |
| [Observability](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/observability)                                                                                                                                                                                                                           | Demonstrates how to add support for metrics, health checks and distributed tracing                                                                                                                                                                                |
| [OpenAPI Contract First](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/openapi-contract-first)                                                                                                                                                                                                         | Shows how to run with Contract First OpenAPI.                                                                                                                                                                                                                     |
| [Platform HTTP security with Keycloak](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/platform-http-security-keycloak)                                                                                                                                                                                  | Shows how to secure platform HTTP with Keycloak                                                                                                                                                                                                                   |
| [REST with Jackson](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/rest-json)                                                                                                                                                                                                                           | Demonstrates how to create a REST service using the Camel REST DSL and Jackson.                                                                                                                                                                                   |
| [Saga and LRA](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/saga)                                                                                                                                                                                                                                     | Shows how to use Saga and LRA                                                                                                                                                                                                                                     |
| [Send and receive messages from Redis](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/spring-redis)                                                                                                                                                                                                     | Shows how to produce and consume messages from Redis, using both basic operations and pub/sub messaging.                                                                                                                                                          |
| [Timer Hello World](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/timer-log)                                                                                                                                                                                                                           | Uses the Camel timer component to output a Hello world message to the console                                                                                                                                                                                     |
| [Tokenize a CSV file](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/file-split-log-xml)                                                                                                                                                                                                                | Shows how to define a Camel route in XML for tokenizing a CSV a file.                                                                                                                                                                                             |
| [Unstructured Data Extraction with LangChain4j](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/data-extract-langchain4j)                                                                                                                                                                                | Shows how to convert unstructured text data to structured Java objects helped with a Large Language Model and LangChain4j                                                                                                                                         |
| [Upload a file to an AWS S3 bucket](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/aws2-s3)                                                                                                                                                                                                             | Shows how to produce and consume messages to an aws2-s3 bucket.                                                                                                                                                                                                   |
| [Vertx-Websocket Chat](https://github.com/jboss-fuse/camel-quarkus-examples/tree/3.27.x-product/vertx-websocket-chat)                                                                                                                                                                                                             | Shows how to configure a WebSocket server and interact with connected peers.                                                                                                                                                                                      |

Show more

## [Legal Notice Copy link](#idm140139105254896)

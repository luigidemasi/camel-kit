...
Do not add Markdown fences, commentary or progress text to the response. Do not edit files, execute commands, call MCP
tools, delegate, switch modes, or publish. The controller applies proposals to its private candidate, computes artifact
hashes, and runs deterministic checks. Report unresolved questions in the structured stage result; the parent owns user
interaction.

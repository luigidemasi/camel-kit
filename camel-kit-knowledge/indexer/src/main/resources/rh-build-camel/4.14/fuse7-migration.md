...
6. [Legal Notice](#idm140602114307392)
...
## Information on migrating from Red Hat Fuse 7 to Red Hat build of Apache Camel for Quarkus.

[Legal Notice](#idm140602114307392)
...
## [Preface Copy link](#idm140602116855600)
...
1. Using the [`https://code.camel.redhat.com`](https://code.camel.redhat.com/) website, select the extensions required for this example:
...
1. Using the [`https://code.camel.redhat.com`](https://code.camel.redhat.com/) website, select the following extensions for this example:
...
## [Legal Notice Copy link](#idm140602114307392)

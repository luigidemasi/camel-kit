...
public enum ShipEventType {
    ...
    DISCOVERY_CONTINUED("discovery-continued"),
    GAP_REVIEW_STARTED("gap-review-started"),
    GAP_REVIEW_REOPENED("gap-review-reopened"),
    REQUIREMENTS_READY("requirements-ready"),
    DESIGN_STARTED("design-started"),
    DESIGN_GAPS_FOUND("design-gaps-found"),
    DESIGN_READY("design-ready"),
    DESIGN_APPROVAL_REQUESTED("design-approval-requested"),
    DESIGN_APPROVED("design-approved"),
    DESIGN_APPROVAL_DENIED("design-approval-denied"),
    DESIGN_REQUIREMENTS_CHANGES_REQUESTED("design-requirements-changes-requested"),
    DESIGN_APPROVAL_ABORTED("design-approval-aborted"),
    ...
    PLAN_DESIGN_CHANGES_REQUESTED("plan-design-changes-requested"),
    PLAN_REQUIREMENTS_CHANGES_REQUESTED("plan-requirements-changes-requested"),
    PLAN_APPROVAL_ABORTED("plan-approval-aborted"),

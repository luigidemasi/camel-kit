...
public class GraphRouteFlowCommand extends GraphQueryCommand {
    @Parameters(index = "0") String routeId;
    @Option(names = {"--from-endpoint"}, defaultValue = "false") boolean fromEndpoint;
    ...
    @Override protected String execute(ProjectGraph graph) {
        ...
        steps.forEach(s -> { ObjectNode o = arr.addObject(); o.put("nodeId", s.nodeId()); o.put("type", s.type()); o.put("label", s.label()); o.put("depth", s.depth()); });

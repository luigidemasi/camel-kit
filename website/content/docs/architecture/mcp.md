...
| **camel-knowledge** | `camel_rh_build_search`, `camel_rh_build_component_info`, `camel_rh_build_cve_search`, `camel_rh_build_bugfix_search`, `camel_rh_build_release_info`, `camel_rh_build_supported_configs` | 6 |

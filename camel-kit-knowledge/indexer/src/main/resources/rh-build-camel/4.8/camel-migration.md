...
2. [Preface](#idm140031910238000)
3. 1. Migrating Apache Camel
4. [Legal Notice](#idm140031903809328)
...
Red Hat build of Apache Camel Support Team https://access.redhat.com/support

[Legal Notice](#idm140031903809328)

**Abstract**

Migrating Apache Camel provides information on migrating between Apache Camel versions.

## [Preface Copy link](#idm140031910238000)
...
- [Camel Quarkus migration and upgrade guides](https://camel.apache.org/camel-quarkus/3.15.x/migration-guide/) .
...
## [Legal Notice Copy link](#idm140031903809328)

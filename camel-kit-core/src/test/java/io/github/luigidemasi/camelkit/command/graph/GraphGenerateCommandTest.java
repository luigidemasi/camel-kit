...
class GraphGenerateCommandTest {
    ...
    @Test void generatesGraphFile() throws Exception {
        Files.writeString(tempDir.resolve("pom.xml"), "<project><modelVersion>4.0.0</modelVersion><groupId>test</groupId><artifactId>test</artifactId><version>1.0</version></project>");
    ...
    @Test void customOutputPath() throws Exception {

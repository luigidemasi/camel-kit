...
6. [Legal Notice](#idm139725162999584)
...
[Legal Notice](#idm139725162999584)
...
## [Preface Copy link](#idm139725163000384)
...
For more information relating to upgrading Camel when you migrate your Red Hat Fuse 7 application to CEQ, see [Migrating Apache Camel](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.8/html-single/migrating_apache_camel/index) .

For more information about using beans in Camel Quarkus, see the [CDI and the Camel Bean Component](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.8/html-single/developing_applications_with_red_hat_build_of_apache_camel_for_quarkus/index#cdi_and_the_camel_bean_component) section in the *Developing Applications with Red Hat build of Apache Camel for Quarkus* guide.
...
## [Legal Notice Copy link](#idm139725162999584)

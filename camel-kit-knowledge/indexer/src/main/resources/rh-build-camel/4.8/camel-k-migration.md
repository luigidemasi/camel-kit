...
2. [Preface](#idm140515196979680)
3. 1. Overview
4. [Legal Notice](#idm140515196933024)
...
[Legal Notice](#idm140515196933024)

**Abstract**

This guide provides details to migrate from Camel K to Red Hat build of Apache Camel for Quarkus.

## [Preface Copy link](#idm140515196979680)
...
## [Chapter 1. Overview Copy link](#overview)
...
- [Section 1.1, "Assumptions"](#assumptions)
- [Section 1.2, "Traits"](#traits)
- [Section 1.3, "Kamel run configuration"](#kamel-run-configuration)
- [Section 1.4, "Kamelets, KameletBindings and Pipes"](#kamelets-kamelet-bindings)
- [Section 1.5, "Migration Process"](#migration-process)
- [Section 1.6, "Troubleshooting"](#troubleshooting)
- [Section 1.7, "Known Issues"](#known-issues)
- [Section 1.8, "Reference documentation"](#documentation)

### [1.1. Assumptions Copy link](#assumptions)
...
#### [1.1.1. Requirements Copy link](#requirements)

To perform the migration, following set of tools and configurations are required.

- [Camel JBang 4.7.0](https://camel.apache.org/manual/camel-jbang.html#_installation) .
- JDK 17 or 21.
- Maven (mvn cli) 3.9.5.
- [oc cli](https://mirror.openshift.com/pub/openshift-v4/clients/ocp/) .
...
#### [1.1.2. Out of scope Copy link](#out_of_scope)
...
#### [1.1.3. Use cases Copy link](#use_cases)
...
#### [1.1.4. Versions Copy link](#versions)
...
#### [1.1.5. Project and Organization Copy link](#project_and_organization)
...
### [1.3. Kamel run configuration Copy link](#kamel-run-configuration)
...
### [1.4. Kamelets, KameletBindings and Pipes Copy link](#kamelets-kamelet-bindings)
...
#### [1.4.1. Knative Copy link](#knative)
...
#### [1.4.2. Monitoring Copy link](#monitoring)
...
### [1.5. Migration Process Copy link](#migration-process)
...
#### [1.5.1. Migration Steps Copy link](#migration_steps)

##### [1.5.1.1. Use Case 1 - Simple Integration Route with Configuration Copy link](#use_case_1_simple_integration_route_with_configuration)
...
##### [1.5.1.1.1. Step 1 - Create the maven project Copy link](#step_1_create_the_maven_project)
...
##### [1.5.1.1.2. Step 2 - Configure the project Copy link](#step_2_configure_the_project)
...
##### [1.5.1.1.3. Step 3 - Build Copy link](#step_3_build)
...
##### [1.5.1.1.4. Step 4 - Build and Deploy Copy link](#step_4_build_and_deploy)
...
##### [1.5.1.1.5. Step 5 - Test Copy link](#step_5_test)
...
##### [1.5.1.2. Use Case 2 - Knative Integration Route Copy link](#use_case_2_knative_integration_route)
...
##### [1.5.1.2.1. Step 1 - Create the maven project Copy link](#step_1_create_the_maven_project_2)
...
##### [1.5.1.2.2. Step 2 - Configure the project Copy link](#step_2_configure_the_project_2)
...
##### [1.5.1.2.3. Step 3 - Build Copy link](#step_3_build_2)
...
##### [1.5.1.2.4. Step 4 - Build and Deploy Copy link](#step_4_build_and_deploy_2)
...
##### [1.5.1.2.5. Step 5 - Test Copy link](#step_5_test_2)
...
##### [1.5.1.3. Use Case 3 - Pipe Copy link](#use_case_3_pipe)
...
##### [1.5.1.3.1. Step 1 - Create the maven project Copy link](#step_1_create_the_maven_project_3)
...
##### [1.5.1.3.2. Step 2 - Configure the project Copy link](#step_2_configure_the_project_3)
...
##### [1.5.1.3.3. Step 3 - Build Copy link](#step_3_build_3)
...
##### [1.5.1.3.4. Step 4 - Build and Deploy Copy link](#step_4_build_and_deploy_3)
...
##### [1.5.1.3.5. Step 5 - Test Copy link](#step_5_test_3)
...
#### [1.5.2. Undeploy kubernetes resources Copy link](#undeploy_kubernetes_resources)
...
#### [1.5.3. Kubernetes CronJob Copy link](#kubernetes_cronjob)
...
### [1.6. Troubleshooting Copy link](#troubleshooting)

#### [1.6.1. Product Support Copy link](#product_support)
...
#### [1.6.2. Ignore loading errors when exporting with camel jbang Copy link](#ignore_loading_errors_when_exporting_with_camel_jbang)
...
#### [1.6.3. Increase logging Copy link](#increase_logging)
...
#### [1.6.4. Disable health checks Copy link](#disable_health_checks)
...
### [1.7. Known Issues Copy link](#known-issues)
...
#### [1.7.1. Camel K features not available in Camel for Quarkus Copy link](#camel_k_features_not_available_in_camel_for_quarkus)
...
##### [1.7.1.1. Owner Trait Copy link](#owner_trait)
...
##### [1.7.1.2. Affinity Trait Copy link](#affinity_trait)
...
##### [1.7.1.3. PodDisruptionBudget Trait Copy link](#poddisruptionbudget_trait)
...
#### [1.7.2. Camel Jbang fails to add camel-quarkus-direct dependency Copy link](#camel_jbang_fails_to_add_camel_quarkus_direct_dependency)
...
#### [1.7.3. Quarkus build fails with Copy link](#quarkus_build_fails_with)
...
#### [1.7.4. Camel Jbang fails to export a route Copy link](#camel_jbang_fails_to_export_a_route)
...
### [1.8. Reference documentation Copy link](#documentation)
...
## [Legal Notice Copy link](#idm140515196933024)

...
4. 3. Migrating to Apache Camel 4
5. 4. Migrating to Apache Camel 3
6. 5. Upgrading Red Hat build of Apache Camel on Spring Boot version with Camel update recipes
7. [Legal Notice](#idm140683687542336)
...
[Legal Notice](#idm140683687542336)
...
## [Chapter 3. Migrating to Apache Camel 4 Copy link](#migrating-to-camel-spring-boot-4)
...
### [3.1. Java versions Copy link](#java_versions)

Apache Camel 4 supports Java 17. Support for Java 11 is dropped.

### [3.2. Removed Components Copy link](#removed_components)
...
### [3.6. API Changes Copy link](#api_changes)
...
### [3.7. EIP Changes Copy link](#eip_changes)
...
#### [3.7.1. Poll Enrich EIP Copy link](#poll_enrich_eip)
...
#### [3.7.2. CircuitBreaker EIP Copy link](#circuitbreaker_eip)
...
For more information about XML IO DSL, refer [XML IO DSL](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.10/html-single/getting_started_with_red_hat_build_of_apache_camel_for_spring_boot/index#csb-camel-spring-xml-io-dsl) .

### [3.9. Type Converter Copy link](#type_converter)

The `String` → `java.io.File` converter has been removed.

### [3.10. Tracing Copy link](#tracing)
...
### [3.11. UseOriginalMessage / UseOriginalBody Copy link](#useoriginalmessage_useoriginalbody)
...
### [3.12. Camel Health Copy link](#camel_health)
...
#### [3.12.1. Producer Health Checks Copy link](#producer_health_checks)
...
### [3.14. YAML DSL Copy link](#yaml_dsl)
...
### [3.15. Backlog Tracing Copy link](#backlog_tracing)
...
### [3.16. XML serialization Copy link](#xml_serialization)
...
### [3.17. OpenAPI Maven Plugin Copy link](#openapi_maven_plugin)
...
### [3.18. Component changes Copy link](#component_changes)

#### [3.18.1. Category Copy link](#category)
...
#### [3.18.2. camel-openapi-rest-dsl-generator Copy link](#camel_openapi_rest_dsl_generator)

This dsl-generator has updated the underlying model classes ( `apicurio-data-models` ) from 1.1.27 to 2.0.3.

#### [3.18.3. camel-atom Copy link](#camel_atom)
...
#### [3.18.6. camel-box Copy link](#camel_box)
...
#### [3.18.7. camel-caffeine Copy link](#camel_caffeine)
...
#### [3.18.8. camel-fhir Copy link](#camel_fhir)
...
#### [3.18.9. camel-google Copy link](#camel_google)
...
#### [3.18.10. camel-http Copy link](#camel_http)
...
#### [3.18.11. camel-http-common Copy link](#camel_http_common)
...
#### [3.18.12. camel-kubernetes Copy link](#camel_kubernetes)
...
#### [3.18.13. camel-main Copy link](#camel_main)
...
#### [3.18.14. camel-micrometer Copy link](#camel_micrometer)
...
#### [3.18.15. camel-jbang Copy link](#camel_jbang)
...
#### [3.18.16. camel-openapi-java Copy link](#camel_openapi_java)
...
#### [3.18.17. camel-salesforce Copy link](#camel_salesforce)
...
### [3.19. Camel Spring Boot Copy link](#camel_spring_boot)
...
#### [3.19.1. Using restConfiguration in a Spring Bean XML Copy link](#using_restconfiguration_in_a_spring_bean_xml)
...
#### [3.19.2. Graceful Shutdown Copy link](#graceful_shutdown)
...
#### [3.19.3. camel-micrometer-starter Copy link](#camel_micrometer_starter)
...
#### [3.19.4. camel-platform-http-starter Copy link](#camel_platform_http_starter)
...
#### [3.19.5. camel-twitter Copy link](#camel_twitter)
...
## [Chapter 4. Migrating to Apache Camel 3 Copy link](#migrating-to-camel-spring-boot3)
...
### [4.1. Modularization of camel-core Copy link](#modularization_of_camel_core)
...
### [4.2. Modularization of Components Copy link](#modularization_of_components)
...
### [4.3. Default Shutdown Strategy Copy link](#csb-migration-default-shutdown)
...
### [4.4. Multiple CamelContexts per application not supported Copy link](#multiple_camelcontexts_per_application_not_supported)
...
### [4.5. Deprecated APIs and Components Copy link](#deprecated_apis_and_components)

All deprecated APIs and components from Camel 2.x have been removed in Camel 3.

#### [4.5.1. Removed components Copy link](#removed_components_2)
...
#### [4.5.2. Renamed components Copy link](#renamed-camel3-components)
...
### [4.6. Changes to Camel components Copy link](#changes_to_camel_components)

#### [4.6.1. Mock component Copy link](#mock_component)
...
#### [4.6.2. ActiveMQ Copy link](#activemq)
...
#### [4.6.4. Camel CXF Copy link](#camel_cxf)
...
##### [4.6.4.1. Camel CXF changed namespaces Copy link](#camel_cxf_changed_namespaces)
...
#### [4.6.7. Telegram Copy link](#telegram)
...
#### [4.6.10. XML DSL Migration Copy link](#xml_dsl_migration)
...
### [4.7. Migrating Camel Maven Plugins Copy link](#migrating_camel_maven_plugins)
...
## [Chapter 5. Upgrading Red Hat build of Apache Camel on Spring Boot version with Camel update recipes Copy link](#csb-camel-upgrade-recipes)
...
### [5.1. Running Camel Updates Copy link](#running_camel_updates)
...
#### [5.1.1. Configuration Options Copy link](#configuration_options)
...
#### [5.1.2. Updating a plain Camel application Copy link](#updating_a_plain_camel_application)
...
#### [5.1.3. Updating a Spring Boot application Copy link](#updating_a_spring_boot_application)
...
## [Legal Notice Copy link](#idm140683687542336)

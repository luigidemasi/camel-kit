...
[Legal Notice](#idm139753205145296)
...
## [Preface Copy link](#idm139753211014800)
...
5. Review the migration guide for items that were not updated by the update command. If your project has such items, implement the additional steps advised in these topics. Note In some cases versions might not upgrade correctly, and may not match the migration to Quarkus. If so, you must change the version manually. See [Migrating Apache Camel](https://content-preview.docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.8/html-single/migrating_apache_camel/index) for instructions.
...
- [Migrating applications to Red Hat build of Quarkus version 3.15](https://docs.redhat.com/en/documentation/red_hat_build_of_quarkus/3.15/html/migrating_applications_to_red_hat_build_of_quarkus_3.15/assembly_migrating-to-quarkus-3_quarkus-migration)

## [Legal Notice Copy link](#idm139753205145296)

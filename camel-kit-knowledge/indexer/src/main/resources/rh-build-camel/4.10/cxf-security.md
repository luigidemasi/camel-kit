...
2. [Preface](#idm140514035630688)
3. 1. Quarkus CXF security guide
4. 2. Camel Security
5. [Legal Notice](#idm140514040514080)
...
##### [1.1.1.1.1. Set the client trust store in application.properties Copy link](#set_the_client_trust_store_in_application_properties)

This is the easiest way to set the client trust store. The key role is played by the following properties:

- [quarkus.cxf.client."client-name".trust-store](https://docs.redhat.com/en/documentation/quarkus_cxf_security_guide_for_red_hat_build_of_apache_camel/4.10/html-single/red_hat_build_of_apache_camel_for_quarkus_reference/#quarkus-cxf_quarkus-cxf-client-client-name-trust-store)
- [quarkus.cxf.client."client-name".trust-store-type](https://docs.redhat.com/en/documentation/quarkus_cxf_security_guide_for_red_hat_build_of_apache_camel/4.10/html-single/red_hat_build_of_apache_camel_for_quarkus_reference/#quarkus-cxf_quarkus-cxf-client-client-name-trust-store-type)
- [quarkus.cxf.client."client-name".trust-store-password](https://docs.redhat.com/en/documentation/quarkus_cxf_security_guide_for_red_hat_build_of_apache_camel/4.10/html-single/red_hat_build_of_apache_camel_for_quarkus_reference/#quarkus-cxf_quarkus-cxf-client-client-name-trust-store-password)
...
The functionality is provided by [`quarkus-cxf-rt-ws-security`](https://docs.redhat.com/en/documentation/quarkus_cxf_security_guide_for_red_hat_build_of_apache_camel/4.10/html-single/red_hat_build_of_apache_camel_for_quarkus_reference/#-rt-ws-security) extension.
...
Use the following client configuration options provided by [`quarkus-cxf`](https://docs.redhat.com/en/documentation/quarkus_cxf_security_guide_for_red_hat_build_of_apache_camel/4.10/html-single/red_hat_build_of_apache_camel_for_quarkus_reference/#) extension to pass the username and password for HTTP basic authentication:

- [quarkus.cxf.client."client-name".username](https://docs.redhat.com/en/documentation/quarkus_cxf_security_guide_for_red_hat_build_of_apache_camel/4.10/html-single/red_hat_build_of_apache_camel_for_quarkus_reference/#quarkus-cxf_quarkus-cxf-client-client-name-username)
- [quarkus.cxf.client."client-name".password](https://docs.redhat.com/en/documentation/quarkus_cxf_security_guide_for_red_hat_build_of_apache_camel/4.10/html-single/red_hat_build_of_apache_camel_for_quarkus_reference/#quarkus-cxf_quarkus-cxf-client-client-name-password)
...
##### [1.1.3.2. UsernameToken policy assertion example Copy link](#usernametoken_policy_assertion_example)
...
## [Legal Notice Copy link](#idm140514040514080)

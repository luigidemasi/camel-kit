...
11. [9. Viewing containers and applications](#viewing-containers-and-applications)
12. 10. Viewing and managing Apache Camel applications
13. [11. Viewing and managing JMX domains and MBeans](#viewing-and-managing-jmx-domains-and-mbeans)
14. [12. Viewing and managing Quartz Schedules](#viewing-and-managing-quatz-schedules)
15. [13. Viewing Threads](#viewing-threads)
16. [14. Ensuring correct data displays in HawtIO](#ensuring-correct-data-displays-in-hawtio)
17. 15. OpenID Connect Integration
18. [Legal Notice](#idm140423196598720)
...
[Legal Notice](#idm140423196598720)
...
### [2.1. Adding Red Hat repositories to Maven Copy link](#adding-repositories-to-maven)
...
### [2.2. Running from CLI (JBang) Copy link](#running-from-cli)
...
1. Install the latest version of HawtIO on your machine using the `jbang` command: `$ jbang app install -Dhawtio.jbang.version = 4.1 .0.redhat-00015 hawtio@hawtio/hawtio` Copy to Clipboard Toggle word wrap Note This installation method is available only with *jbang&gt;=0.115.0* .
...
### [2.3. Running a Quarkus app Copy link](#running-a-quarkus-app)
...
#### [2.4.1. Configuring HawtIO path Copy link](#configuring_hawtio_path)
...
#### [3.5.2. Deploying hawtconfig.json Copy link](#deploying_literal_hawtconfig_json_literal)
...
You can find an example Quarkus project [here](https://github.com/jboss-fuse/hawtio-examples/tree/rhbac-4.8/quarkus) .
...
You can find an example Spring Boot project [here](https://github.com/jboss-fuse/hawtio-examples/tree/rhbac-4.8/springboot-authentication) .
...
### [4.1. Configuration properties Copy link](#configuration_properties)
...
See [Quarkus example]({hawtio-examples-url}quarkus) for a working example of the properties-based authentication.

#### [4.2.2. Quarkus with Keycloak Copy link](#quarkus_with_keycloak)

See [Keycloak Integration - Quarkus](#keycloak-integration-quarkus) .

### [4.3. Spring Boot Copy link](#spring_boot_3)

In addition to the standard JAAS authentication, HawtIO on Spring Boot can be secured through [Spring Security](https://spring.io/projects/spring-security) or [Keycloak](https://www.keycloak.org/) . If you want to disable HawtIO authentication for Spring Boot, add the following configuration to `application.properties` :
...
#### [4.3.2. Spring Boot with Keycloak Copy link](#spring_boot_with_keycloak)

See [Keycloak Integration - Spring Boot](#keycloak-integration) .

### [4.4. Keycloak Integration Copy link](#keycloak-integration)
...
#### [4.4.1. Prepare Keycloak server Copy link](#prepare_keycloak_server)
...
#### [4.4.2. Configuration Copy link](#configuration)
...
##### [4.4.2.1. Quarkus Copy link](#keycloak-integration-quarkus)
...
##### [4.4.2.1.1. Server side Copy link](#server_side)
...
##### [4.4.2.1.2. Client side Copy link](#client_side)
...
##### [4.4.2.1.3. Example Copy link](#example)

See [quarkus-keycloak example](https://github.com/hawtio/hawtio/tree/4.x/examples/quarkus-keycloak) for a working example.

##### [4.4.2.2. Spring Boot Copy link](#spring_boot_4)
...
##### [4.4.2.2.1. Server side Copy link](#server_side_2)
...
##### [4.4.2.2.2. Client side Copy link](#client_side_2)
...
##### [4.4.2.2.3. Example Copy link](#example_2)

See [springboot-keycloak example](https://github.com/hawtio/hawtio/tree/4.x/examples/springboot-keycloak) for a working example.
...
| Diagnostics                                                                                           | Allows you to control the Java Flight Recorder, see class histogram and access to JVM flags.  **Not yet ported to v3.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
[https://github.com/hawtio/hawtio/tree/4.x/examples/sample-plugin](https://github.com/hawtio/hawtio/tree/4.x/examples/sample-plugin)
...
On OpenShift 4.x, setting up HawtIO involves installing and deploying it. The preferred mechanism for this installation is using the HawtIO Operator available from the OperatorHub []). Optionally, you can customize role-based access control (RBAC) for HawtIO as described in xref:role-based-access-control-for-hawtio-on-openshift-4[](#installing-and-deploying-hawtio-on-openshift-4-by-using-operatorhub) .
...
1. Customize these values as needed: `archetypeVersion` 4.8.0.redhat-00022 `groupId io.hawtio.online.examples artifactId hawtio-online-example-camel-springboot-os version 1.0.0`
...
- [Camel Spring Boot Starter Configuration](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.8/html/getting_started_with_red_hat_build_of_apache_camel_for_spring_boot/getting-started-with-camel-spring-boot_csb#camel-spring-boot-listgetting-started-with-camel-spring-boot_csb#camel-spring-boot-starter-configuration)
- [Deploying a Spring Boot Camel application to OpenShift](https://docs.redhat.com/en/documentation/red_hat_build_of_apache_camel/4.8/html/getting_started_with_red_hat_build_of_apache_camel_for_spring_boot/getting-started-with-camel-spring-boot_csb#camel-spring-boot-listgetting-started-with-camel-spring-boot_csb#deploying-camel-spring-boot-application-to-openshift)
...
## [Chapter 9. Viewing containers and applications Copy link](#viewing-containers-and-applications)
...
## [Chapter 10. Viewing and managing Apache Camel applications Copy link](#viewing-and-managing-apache-camel-applications)
...
### [10.1. Starting, suspending, or deleting a context Copy link](#starting_suspending_or_deleting_a_context)
...
### [10.2. Viewing Camel application details Copy link](#viewing_camel_application_details)
...
### [10.3. Viewing a list of the Camel routes and interacting with them Copy link](#viewing_a_list_of_the_camel_routes_and_interacting_with_them)
...
### [10.4. Debugging a route Copy link](#debugging_a_route)
...
## [Chapter 11. Viewing and managing JMX domains and MBeans Copy link](#viewing-and-managing-jmx-domains-and-mbeans)
...
## [Chapter 12. Viewing and managing Quartz Schedules Copy link](#viewing-and-managing-quatz-schedules)
...
## [Chapter 13. Viewing Threads Copy link](#viewing-threads)
...
## [Chapter 14. Ensuring correct data displays in HawtIO Copy link](#ensuring-correct-data-displays-in-hawtio)
...
## [Chapter 15. OpenID Connect Integration Copy link](#openid-connect-integration)

HawtIO is already supporting [Keycloak](https://hawt.io/docs/keycloak.html) as [OpenID Provider](https://openid.net/specs/openid-connect-core-1_0.html#Terminology) . However, Keycloak [already announced](https://www.keycloak.org/2022/02/adapter-deprecation) that the configuration methods used by HawtIO are deprecated. As [OpenID Connect Core 1.0](https://openid.net/specs/openid-connect-core-1_0.html) is a widespread specification and standard method for distributed authentication (based on [OAuth 2](https://datatracker.ietf.org/doc/html/rfc6749) ), HawtIO 4 now supports generic OpenID authentication.

### [15.1. Building blocks and terminology Copy link](#building_blocks_and_terminology)

To understand how HawtIO uses OpenID Connect and OAuth2, it is worth recalling some fundamental concepts. There are 3 main parties involved in distributed authentication based on OpenID Connect (which is build on [OAuth2](https://datatracker.ietf.org/doc/html/rfc6749) ):
...
### [15.2. Generic OpenID Connect authentication in HawtIO Copy link](#generic_openid_connect_authentication_in_hawtio)
...
Unlike with [Keycloak](https://hawt.io/docs/keycloak.html) specific configuration, there's only one *.properties file needed that is used to configure all the aspects of OpenID Connect configuration.
...
### [15.3. JAAS role class configuration Copy link](#jaas_role_class_configuration)
...
### [15.4. Using HawtIO and OpenID Connect authentication with Keycloak Copy link](#using_hawtio_and_openid_connect_authentication_with_keycloak)
...
#### [15.4.1. Investigating JWT token issues Copy link](#investigating_jwt_token_issues)
...
### [15.5. Using HawtIO and OpenID Connect authentication with Microsoft Entra ID Copy link](#using_hawtio_and_openid_connect_authentication_with_microsoft_entra_id)
...
#### [15.5.1. Using single SPA client in Entra ID Copy link](#using_single_spa_client_in_entra_id)
...
#### [15.5.2. Using SPA together with Web client in Entra ID Copy link](#using_spa_together_with_web_client_in_entra_id)
...
#### [15.5.3. Access token configuration Copy link](#access_token_configuration)
...
## [Legal Notice Copy link](#idm140423196598720)

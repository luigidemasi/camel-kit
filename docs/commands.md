...
4. When a Kubernetes deployment target is detected (e.g., CloudHub artifacts or K8s manifests), the deployment migration guide is automatically loaded to map CloudHub deployment patterns to Kubernetes equivalents.
